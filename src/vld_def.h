...
#define VLD_OPT_TRACKING_PAUSED         0x8000 //   If set, not currently tracking allocs/frees...

#define VLD_RPTHOOK_INSTALL  0
#define VLD_RPTHOOK_REMOVE   1

typedef int (__cdecl * VLD_REPORT_HOOK)(int reportType, wchar_t *message, unsigned nchars, int *returnValue);
