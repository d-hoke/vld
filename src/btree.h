...
//based on https://code.google.com/archive/p/cpp-btree/issues/22, try static_assert
#define COMPILE_ASSERT(expr, msg) \
...
#if 0 //TBD: trouble compiling, "'btree::btree<Params>::key_compare_checker':  no matching overloaded function found"...
